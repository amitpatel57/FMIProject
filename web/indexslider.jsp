            ...
            <div class="row">
                <div class="col-sm-12 m-0 p-0 p-relative">
                    ...
                    <div class="h_100 w_100 p-absolute top-0 bg_opacity text-center text-white d-flex justify-content-center align-item-center direction_col">
                        ...
                        <h1 class="fs-21">Distribution, Storage, Warehousing & Fulfillment</h1>
                        <p class="fs-15">Providing Best Cold Storage Services in Lucknow.</p>
                        <a href="contactus.jsp"><button class="button">Enquire Now</button></a>
                    </div>
                </div>
            </div>
